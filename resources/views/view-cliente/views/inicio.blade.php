        ...
        <div class="container-fluid py-4 px-5">
            <div class="d-md-flex align-items-center mb-3 mx-2">
                <div class="mb-md-0 mb-3">
                    ...
                    <p class="mb-0">Visualiza tus reservas</p>
                </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Mis Reserva</h6>
                                    <p class="text-sm mb-sm-0">Lista de reserva solicitadas</p>
                                </div>
                                    ...
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                                Costo</th>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Estado
                                            </th>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                                Tipo de servicio</th>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                   ...
                                   <tbody>
                                        @foreach ($reservas as $reserva)
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $reserva->fecha_servicio }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $reserva->costo_adicional }}
                                                    </p>
                                                </td>
                                                <td>
                                                ...
                                                @if ($reserva->transaccion && $reserva->transaccion->estado)
                                                <td class="align-middle">
                                                    <div class="d-flex">

                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{$reserva->transaccion->estado}}</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p  class="badge badge-sm border border-danger text-danger bg-danger">No pagado</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $reserva->servicio->nombre }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $reserva->conductor->nombre }}</p>

                                                        </div>
                                                    </div>
                                                </td>
                                                @if ($reserva->tipo_servicio == "con reserva" && (!$reserva->transaccion || $reserva->transaccion->estado != "completado"))

                                                <td class="align-middle">


                                                    <a type="button" href="{{ route('cliente.pagoReserva', ['id_reserva' => $reserva->id]) }}"
                                                        class="badge badge-sm border border-success text-success bg-success"
                                                        data-bs-toggle="tooltip" data-bs-title="Pagar"> Pagar
                                                ...
                                                @endif
                                                <td class="align-middle">
                                                    <a href="#" class="badge badge-sm border border-warning text-warning bg-warning"
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <a type="button" href="{{ route('cliente.showPago', ['id_reserva' => $reserva->id]) }}"
                                                        class="badge badge-sm border border-info text-info bg-info"
                                                        data-bs-toggle="tooltip" data-bs-title="Pagar"> Informacion de pago
                                ...
                                <nav aria-label="..." class="ms-auto">
                                    <ul class="pagination pagination-light mb-0">
                                        ...
                                        @for ($i = 1; $i <= $reservas->lastPage(); $i++)
                                            <li
                                                class="page-item {{ $reservas->currentPage() == $i ? 'active' : '' }}">
