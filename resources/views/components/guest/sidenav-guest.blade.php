    ...
    <div class="container-fluid px-1">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto ms-xl-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-2 {{ is_current_route('conductor-login') ? 'active' : '' }}"
                        href="{{ route('conductor.login') }}">
                        <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" class="me-1">
                            <path fill-rule="evenodd"
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-2 {{ is_current_route('cliente-login') ? 'active' : '' }}"
