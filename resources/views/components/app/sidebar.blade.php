...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main" style="overflow-x: hidden">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            >
            <span class="font-weight-bold text-lg">CONDUCTOR DESIGNADO</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
          ...
          {{--   <li class="nav-item">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('cliente.index') ? 'active' : '' }}"
                    href="{{ route('cliente.index') }}">
                    <span class="nav-link-text ms-1">Clientes</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('conductor.index') ? 'active' : '' }}"
                    href="{{ route('conductor.index') }}">
                    <span class="nav-link-text ms-1">Conductor</span>
                </a>
            </li>

            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('personal.index') ? 'active' : '' }}"
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('vehiculo.index') ? 'active' : '' }}"
                    href="{{ route('vehiculo.index') }}">
                    <span class="nav-link-text ms-1">Vehiculo</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
