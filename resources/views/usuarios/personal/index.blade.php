                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Personal</h6>
                                    <p class="text-sm mb-sm-0">Lista de personal registrados</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <a type="button" href="{{ route('personal.create') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        ...
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">{{ $personal->nombre }}
                                                                {{ $personal->apellido }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $personal->genero }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $personal->correo }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <span
                                                        class="text-sm font-weight-normal">{{ $personal->fecha_de_nacimiento }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $personal->salario }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $personal->cargo }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('personal.edit', ['id_personal' => $personal->id]) }}"
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('personal.delete', $personal->id) }}"
                                                        class="text-secondary font-weight-bold text-xs"
                            ...
                            <div class="border-top py-3 px-3 d-flex align-items-center">
                                ...
                                <nav aria-label="..." class="ms-auto">
                                    <ul class="pagination pagination-light mb-0">
                                        <!-- Links a las páginas -->
                                        @for ($i = 1; $i <= $personales->lastPage(); $i++)
                                            <li
                                                class="page-item {{ $personales->currentPage() == $i ? 'active' : '' }}">
                                                <a class="page-link border-0 font-weight-bold"
                                                    href="{{ $personales->url($i) }}">{{ $i }}</a>
                                            </li>
                                        @endfor
                                    </ul>
                                </nav>
