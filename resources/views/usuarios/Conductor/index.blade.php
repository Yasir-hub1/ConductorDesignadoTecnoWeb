                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Conductores</h6>
                                    <p class="text-sm mb-sm-0">Lista de conductores registrados</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <a type="button" href="{{ route('conductor.create') }}"
                        ...
                        <div class="card-body px-0 py-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2">
                                                        ...
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm">{{ $conductor->nombre }}
                                                                {{ $conductor->apellido }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $conductor->genero }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $conductor->correo }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <span
                                                        class="text-sm font-weight-normal">{{ $conductor->fecha_de_nacimiento }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $conductor->numero_de_licencia_de_conducir }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $conductor->tipo_de_licencia }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $conductor->fecha_de_vencimiento_de_la_licencia }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $conductor->estado }}</p>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('conductor.edit', ['id_conductor' => $conductor->id]) }}"
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('conductor.delete', $conductor->id) }}"
                                                        class="text-secondary font-weight-bold text-xs"
                            ...
                            <div class="border-top py-3 px-3 d-flex align-items-center">
                                <!-- Botón Previous -->
                                @if ($conductores->onFirstPage())
                                    <button class="btn btn-sm btn-white d-sm-block d-none mb-0"
                                        disabled>Anterior</button>
                                @else
                                    <a href="{{ $conductores->previousPageUrl() }}"
                                ...
                                <nav aria-label="..." class="ms-auto">
                                    <ul class="pagination pagination-light mb-0">
                                        <!-- Links a las páginas -->
                                        @for ($i = 1; $i <= $conductores->lastPage(); $i++)
                                            <li
                                                class="page-item {{ $conductores->currentPage() == $i ? 'active' : '' }}">
                                                <a class="page-link border-0 font-weight-bold"
                                                    href="{{ $conductores->url($i) }}">{{ $i }}</a>
                                            </li>
                                        @endfor
                                    </ul>
                                </nav>
                                ...
                                <!-- Botón Next -->
                                @if ($conductores->hasMorePages())
                                    <a href="{{ $conductores->nextPageUrl() }}"
