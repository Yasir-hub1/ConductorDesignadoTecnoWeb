                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Clientes</h6>
                                    <p class="text-sm mb-sm-0">Lista de clientes registrados</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <a type="button" href="{{ route('cliente.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($clientes as $cliente)
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $cliente->genero }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-normal mb-0">{{ $cliente->correo }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <span
                                                        class="text-sm font-weight-normal">{{ $cliente->fecha_de_nacimiento }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="text-dark text-sm mb-0">{{ $cliente->ci }}</p>

                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle">
                                                    <a href="{{ route('cliente.edit',["id_cliente"=>$cliente->id] ) }}"
