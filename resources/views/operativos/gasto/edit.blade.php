                    ...
                    <div class="col-lg-9 col-12 ">
                        <div class="card " id="basic-info">
                            ...
                            <div class="pt-0 card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="monto" id="monto"
                                            value="{{ $gasto->monto }}" class="form-control">
                                        @error('monto')
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="date" name="fecha" id="fecha"
                                            value="{{ $gasto->fecha }}" class="form-control">
                                        @error('fecha')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="descripcion" id="descripcion"
                                            value="{{ $gasto->descripcion }}" class="form-control">
                                        @error('descripcion')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <a type="submit" href="{{ route('gasto.index') }}"
